      ...
      <div className="flex flex-col gap-16 mt-12">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-4">
            <h2 className="text-6xl sm:text-7xl md:text-8xl lg:text-[7rem] xl:text-[8rem] font-bold text-foreground tracking-tighter leading-[0.9] transition-colors duration-300">
              What We Do
            </h2>
